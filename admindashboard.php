<?php
// admindashboard.php - Main Dashboard (Upgraded Premium Themed Aesthetics)
...
<body>
    ...
    <nav>
        <div class="nav__header">
            <div class="nav__logo"><a href="admindashboard.php" class="logo"><?= htmlspecialchars($system_name) ?><span>.</span></a></div>
        ...
        <ul class="nav__links" id="nav-links">
            ...
            <li><a href="admindashboard.php" style="color: #d4af37; font-weight: 600;">Dashboard</a></li>
    ...
    <div class="admin-workspace-container">
        ...
        <section class="admin-section-card" style="margin-top: 2rem; margin-bottom: 2rem;">
            ...
            <div style="margin-top: 1rem;">
                ...
                <?php endif; ?>
                <form method="POST" action="admindashboard.php" style="display: flex; gap: 1rem; align-items: center;">
